 ...
 * @author DangKhoa
 */
public class BangCongKiemKhoBUS {
    public static void getCBboxMaNV(JComboBox maNhanVien) {
        BangCongKiemKhoDAL.getCBboxMaNV(maNhanVien);
    }
    
    public static void getCBboxMaNVTb(JComboBox maNhanVien) {
        BangCongKiemKhoDAL.getCBboxMaNVTb(maNhanVien);
    }
    
    public static void getCBboxMaBoPhan(JComboBox maBoPhan) {
        BangCongKiemKhoDAL.getCBboxMaBoPhan(maBoPhan);
    }
    ...
    public static void Them(String maNhanVien, String luongCoBan, String phuCap, String phuCapKhac, String thang, String nam, String soNgayCong, 
        ...
        BangCongKiemKhoDAL.Them(maNhanVien, luongCoBan, phuCap, phuCapKhac, thang, nam, soNgayCong, soNgayNghi, soGioLam, ghiChu, maBoPhan);
    }
    
    public static void Xoa(String maNhanVien) {
        BangCongKiemKhoDAL.Xoa(maNhanVien);
    }
    ...
    public static void Sua(String luongCoBan, String phuCap, String phuCapKhac, String thang, String nam, String soNgayCong, 
        ...
        BangCongKiemKhoDAL.Sua(luongCoBan, phuCap, phuCapKhac, thang, nam, soNgayCong, soNgayNghi, soGioLam, ghiChu, maBoPhan, maNhanVien);
    }
}
