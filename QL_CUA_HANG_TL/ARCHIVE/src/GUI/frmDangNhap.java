...
public class frmDangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/computer-icons-login-user-system-administrator-image-admin-8f0e4fdd82da209f6853aaf5f0c8afda.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(icoTenDangNhap, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(icoPassword, javax.swing.GroupLayout.Alignment.LEADING))
                .addGap(37, 37, 37))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        if (txtUsername.getText().equals("") == true && txtPassword.getText().equals("") == true){
            ...
            try {          
                ...
                conn = DriverManager.getConnection("jdbc:sqlserver://localhost;"
                        + "databaseName=QLNS;" + "username=sa;password=lenhha12345::");                       
                ...
                if (rs.next()) {
                    ...
                    if (ten.equalsIgnoreCase("Director")) {
                        ...
                        main.k = 0;
                        main.execute();
                    } else if (ten.equalsIgnoreCase("Manager")) {
                        lblThongBao.setText("Đăng nhập thành công");
                        this.dispose();
                        frmMain main = new frmMain();
                        main.setVisible(true);
                        ...
                        main.k = 1;
                        main.execute();
                    } else if (ten.equalsIgnoreCase("Employee")) {
                        lblThongBao.setText("Đăng nhập thành công");
                        this.dispose();
                        frmMain main = new frmMain();
                        main.setVisible(true);
