...
public class frmQLNhanSu extends javax.swing.JPanel {
    ...
    public void showNS() {
        ...
        for (int i=0;i<nscn.size();i++) {
            ...
            row[1]=nscn.get(i).getMaNhanVien();
            row[2]=nscn.get(i).getHoTen();
            row[3]=nscn.get(i).getNgaySinh();
            row[4]=nscn.get(i).getGioiTinh();
            row[5]=nscn.get(i).getCMND();
            row[6]=nscn.get(i).getNgayCap();
            row[7]=nscn.get(i).getNoiCap();
            row[8]=nscn.get(i).getChucVu();
            row[9]=nscn.get(i).getChucDanh();
            row[10]=nscn.get(i).getLoaiHD();
            row[11]=nscn.get(i).getNgayKy();
            row[12]=nscn.get(i).getNgayHetHan();
            row[13]=nscn.get(i).getGhiChu();
            model.addRow(row);
        };
    }
    ...
    private void initComponents() {
        ...
        cbxMaBoPhan.setForeground(new java.awt.Color(255, 0, 255));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(lblGhiChu, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(txtNgayCap, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(2, 2, 2)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(lblNgayCap, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã bộ phận", "Mã nhân viên", "Họ tên", "Ngày sinh", "Giới tính", "CMND", "Ngày cấp", "Nơi cấp", "Chức vụ", "Chức danh", "Loại HĐ", "Ngày ký", "Ngày hết hạn", "Ghi chú"
            }
        ) {
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        txtCMND.setText(model.getValueAt(i, 5).toString());
        txtNoiCap.setText(model.getValueAt(i, 7).toString());
        cbxChucVu.setSelectedItem(model.getValueAt(i, 8).toString());
        txtChucDanh.setText(model.getValueAt(i, 9).toString());
        txtLoaiHD.setText(model.getValueAt(i, 10).toString());
        txtGhiChu.setText(model.getValueAt(i, 13).toString());
        try {
            Date NgaySinh = new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(i, 3));
            txtNgaySinh.setDate(NgaySinh);
            Date NgayCap = new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(i, 6));
            txtNgayCap.setDate(NgayCap);
            Date NgayKy = new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(i, 11));
            txtNgayKy.setDate(NgayKy);
            Date NgayHetHan = new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(i, 12));
    ...
    private void btnXuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatActionPerformed
        // TODO add your handling code here:
        String link = "D:\\Ex_java\\QL_CUA_HANG_TL\\ARCHIVE\\src\\Report\\frmBaoCaoNhanSu.jrxml";
        try {
    ...
    private void btnMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoiActionPerformed
        ...
        QLNhanSuBUS.Moi(cbxMaBoPhan, txtMaNhanVien, txtHoTen, txtNgaySinh, cbxGioiTinh, txtCMND, txtNgayCap, txtNoiCap, cbxChucVu, txtChucDanh, txtLoaiHD, txtNgayKy, txtNgayHetHan, txtGhiChu);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        QLNhanSuDAL.Sua(cbxMaBoPhan.getSelectedItem().toString(), txtHoTen.getText(), NgaySinh, cbxGioiTinh.getSelectedItem().toString(),
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (txtHoTen.getText().equals("") == true) {
            ...
            String NgayKy = dateFormat.format(txtNgayKy.getDate());
            String NgayHetHan = dateFormat.format(txtNgayHetHan.getDate());
            QLNhanSuDAL.Them(cbxMaBoPhan.getSelectedItem().toString(),
