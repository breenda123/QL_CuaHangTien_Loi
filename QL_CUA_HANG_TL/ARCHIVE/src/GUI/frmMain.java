...
//        });
        ...
        if (k == 0) {
            MenuItem menuDanhMuc = new MenuItem(iconDanhMuc, "Danh Mục", null, menuNhanSu, menuTTCN, menuLuong);
            MenuItem menuQuanLy = new MenuItem(iconQuanLy, "Quản Lý", null, menuBoPhan, menuBangCong);
    ...
    private void initComponents() {
        ...
        lblLogo.setText("Phần mềm quản lý nhân sự cửa hàng tiện lợi");
